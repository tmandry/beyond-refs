...
//!
//! The items from this module will not end up in the standard library, instead the compiler will be
//! modified to implement the desired behavior in the language directly.
