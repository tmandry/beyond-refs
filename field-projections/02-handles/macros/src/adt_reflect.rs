...
fn generate_fields(
    ...
    for field in &fields_named.named {
        ...
        lang_limits.push(quote! {
            ...
            unsafe impl #impl_gen ::field_projection_design::design::subplace::Subplace
...
fn generate_for_enum(
    ...
    for variant in &enum_.variants {
        ...
        lang_limits.push(quote! {
            ...
            impl #impl_gen ::field_projection_design::design::enums::HasVariant<#variant_name_str>
    ...
    lang_limits.push(quote! {
        unsafe impl #impl_gen ::field_projection_design::design::enums::Matchable for #enum_ident #ty_gen #whr {
